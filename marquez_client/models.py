...
class Job:
	def __init__(self, name, created_at, updated_at, input_dataset_urns, output_dataset_urns, location, description):
		self._name = name
		self._created_at = created_at
...
class JobRun:
	def __init__(self, run_id, nominal_start_time, nominal_end_time, run_args, run_state):
		self._run_id = run_id
